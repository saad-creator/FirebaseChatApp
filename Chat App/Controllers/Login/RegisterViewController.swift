...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        RegisterButton.addTarget(self, action: #selector(LoginButtonTabbed), for: .touchUpInside)
    ...
    func alertUserLoginError(message: String = "Please enter all the info to create an account") {
